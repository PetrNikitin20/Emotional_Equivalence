...
class LexiconLoader:
    ...
    def load_emotion_lexicons(self):
        try:
            ...
            print(f"✓ English emotion lexicon: {len(self.english_emotion_lexicon)} words")
        except Exception as e:
            print(f"✗ Error loading the English emotion lexicon: {e}")
        ...
        try:
            ...
            print(f"✓ Russian emotion lexicon: {len(self.russian_emotion_lexicon)} words")
        except FileNotFoundError:
            print(f"✗ Russian-NRC-EmoLex.txt was not found in the data directory.")
            self.russian_emotion_lexicon = {}
        except Exception as e:
            print(f"✗ Error loading the Russian emotion lexicon: {e}")
            self.russian_emotion_lexicon = {}
    ...
    def load_vad_lexicon(self):
        try:
            ...
            print(f"✓ VAD lexicon: {len(self.vad_lexicon)} words")
        except Exception as e:
            print(f"✗ Error loading the VAD lexicon: {e}")
    ...
    def load_cultural_markers(self):
        try:
            ...
            print(f"✓ Cultural markers: {len(self.cultural_markers)}")
        except Exception as e:
            print(f"✗ Error loading cultural markers: {e}")
            self.cultural_markers = []
