"""
Application for analysing emotional preservation in literary translation
"""
...
def analyze_pair(original, translated):
    """Analyse a source-translation pair"""
    ...
    # Generate an overall recommendation with the LLM
    recommendation = llm_advisor.generate_recommendation(
        ...
        k_result['k_score'],
        emotion_orig['dominant_label'],
        emotion_trans['dominant_label']
    )
    
    # Generate recommendations for problematic cultural markers
